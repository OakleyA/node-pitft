...
var drawDial = function () {
    ...
    for (var a = 0; a < 360; a += 6) {
        ...
        if (a % 30 == 0) {
            var x1 = xMax / 2 + Math.sin(a / RA) * (radius * 0.85);
            var y1 = yMax / 2 + Math.cos(a / RA) * (radius * 0.85);
            fb.line(x0, y0, x1, y1, radius * 0.05);
        } else {
            var x1 = xMax / 2 + Math.sin(a / RA) * (radius * 0.90);
            var y1 = yMax / 2 + Math.cos(a / RA) * (radius * 0.90);
